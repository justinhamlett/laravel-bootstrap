                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <label class="checkbox">
                            <?php $checkedArray = Input::old('removeImage', [] ); ?>
                            {{ Form::checkbox('removeImage[]', $upload->id, in_array( $upload->id, $checkedArray ) ) }}
                            Remove Image
                        </label>
                    </div>
                </div>
        ...
        <div id="item-media" class="row">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="thumbnail">
                ...
                <div class="caption">
                  <label class="checkbox">
                    <?php $checkedArray = Input::old('addImage', [] ); ?>
                    {{ Form::checkbox('addImage[]', $upload->id ) }}
                    Add Image
                  </label>
                </div>
              </div>
